        ...
        if len(boxes) > 0:
            for classId, confidence, box in zip(classes.flatten(), confidences.flatten(), boxes):
                if classId != 0:
                    continue
                if grid_40 == "0":
                    grid_40 = grid_exist_top(box, grid_y = 180, grid_x_left = 0, grid_x_right = 135)
                if grid_41 == "0":
                    grid_41 = grid_exist_top(box, grid_y = 180, grid_x_left = 136, grid_x_right = 315)
                if grid_42 == "0":
                    grid_42 = grid_exist_top(box, grid_y = 180, grid_x_left = 316, grid_x_right = 500)
                if grid_43 == "0":
                    grid_43 = grid_exist_top(box, grid_y = 180, grid_x_left = 501, grid_x_right = 672)
                if grid_44 == "0":
                    grid_44 = grid_exist_top(box, grid_y = 180, grid_x_left = 673, grid_x_right = 847)
                if grid_8 == "0":
                    grid_8 = grid_exist_down(box, grid_y = 705, road_y = 750, grid_x_left = 848, grid_x_right = 1019)
                if grid_9 == "0":
                    grid_9 = grid_exist_down(box, grid_y = 705, road_y = 750, grid_x_left = 235, grid_x_right = 437)
                if grid_10 == "0":
                    grid_10 = grid_exist_down(box, grid_y = 705, road_y = 750, grid_x_left = 438, grid_x_right = 656)
                if grid_11 == "0":
                    grid_11 = grid_exist_down(box, grid_y = 705, road_y = 750, grid_x_left = 657, grid_x_right = 828)
                '''
                ...
                '''
        result = grid_40 + " " + grid_41 + " " + grid_42 + " " + grid_43 + " " + grid_44 + " " + grid_8 + " " + grid_9 + " " + grid_10 + " " + grid_11
        print(result)
