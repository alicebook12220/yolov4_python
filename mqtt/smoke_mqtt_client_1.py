        ...
        if len(boxes) > 0:
            for classId, confidence, box in zip(classes.flatten(), confidences.flatten(), boxes):
                if classId != 0:
                    continue
                if grid_31 == "0":
                    grid_31 = grid_exist_top(box, grid_y = 180, grid_x_left = 0, grid_x_right = 135)
                if grid_32 == "0":
                    grid_32 = grid_exist_top(box, grid_y = 180, grid_x_left = 136, grid_x_right = 315)
                if grid_33 == "0":
                    grid_33 = grid_exist_top(box, grid_y = 180, grid_x_left = 316, grid_x_right = 500)
                if grid_34 == "0":
                    grid_34 = grid_exist_top(box, grid_y = 180, grid_x_left = 501, grid_x_right = 672)
                if grid_35 == "0":
                    grid_35 = grid_exist_top(box, grid_y = 180, grid_x_left = 501, grid_x_right = 672)
                if grid_1 == "0":
                    grid_1 = grid_exist_down(box, grid_y = 705, road_y = 750, grid_x_left = 673, grid_x_right = 847)
                if grid_2 == "0":
                    grid_2 = grid_exist_down(box, grid_y = 705, road_y = 750, grid_x_left = 848, grid_x_right = 1019)
                if grid_3 == "0":
                    grid_3 = grid_exist_down(box, grid_y = 705, road_y = 750, grid_x_left = 235, grid_x_right = 437)
                if grid_4 == "0":
                    grid_4 = grid_exist_down(box, grid_y = 705, road_y = 750, grid_x_left = 235, grid_x_right = 437)
                ...
                '''
        result = grid_31 + " " + grid_32 + " " + grid_33 + " " + grid_34 + " " + grid_35 + " " + grid_1 + " " + grid_2 + " " + grid_3 + " " + grid_4
        print(result)
